    ...
    constructor($obj) {
        if ($obj instanceof jQuery) {
            ...
            this.$el = {
                ...
                $divider: jQuery('<div class="ashade-before-after-divider"><i class="fa fa-arrows-h"></i></div>').appendTo($obj),
            };
...
ashade.init = function() {
    ...
    let ashade_mobile_header = jQuery('<div class="ashade-mobile-header">'),
        mobile_menu_button = jQuery('<a href="#" class="ashade-mobile-menu-button"><i class="fa fa-bars"></i></a>').appendTo(ashade_mobile_header),
    ...
    if ($ashade_body.hasClass('ashade-maintenance-wrap')) {
        ashade_mobile_header.prepend('<a class="ashade-contacts-toggler" href="#"><i class="fa fa-envelope"></i></a>');
